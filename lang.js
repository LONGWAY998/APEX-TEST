...
(function() {
    const translations = {
        en: {
            ...
            'hero.stat1.unit': 'B',
            'hero.stat2.label': 'Return Potential',
            ...
            'products.featured.desc': '≥90% allocation to high-grade credit, interest rate bonds & interbank CDs. Leveraging Fujian regional advantages to select AAA+ notes from state-owned banks and institutional platforms. Aiming for competitive double-digit annualized returns.*',
            'products.fph1.title': 'AAA+ Credit Rating',
            'products.fph1.desc': 'State-owned banks & institutional platforms only',
            'products.fph2.title': 'Double-Digit Return Potential',
            'products.fph2.desc': 'Prudent risk management',
            ...
            'fund.hl1.desc': '≥90% allocation to high-grade credit, interest rate bonds & interbank CDs. Aiming for competitive double-digit annualized returns. Past performance range: 10%—13.5% p.a.*',
        ...
        zh: {
            ...
            'products.featured.desc': '不低於90%資產配置於高等級信用、利率債及同業單，依託福建區域優勢精選國有銀行及機構平台AAA+票據，力求具競爭力的雙位數年化回報。*',
            'products.fph1.title': 'AAA+ 信用評級',
            'products.fph1.desc': '僅投國有銀行及機構平台',
            'products.fph2.title': '雙位數回報潛力',
            'products.fph2.desc': '審慎風險管理',
            ...
            'fund.hl1.desc': '不低於90%資產配置於高等級信用、利率債及同業單，力求具競爭力的雙位數年化回報。過往表現區間：10%—13.5% 年化。*',
            ...
            'fund.facts.return.val': '10%—13.5% 年化*',
