...
(function() {
    const translations = {
        en: {
            ...
            'nav.disclosure': 'Disclosures',
            'nav.contact': 'Contact',

            // Hero - index
            'hero.heading': 'Disciplined Capital, <span class="highlight">Transparent</span> Management',
            'hero.subtitle': 'Jinnong Sui Capital provides disciplined fund management solutions across fixed-income, quantitative, and risk-managed strategies.',
            'hero.cta': 'View Products',
            'hero.cta2': 'Review Disclosures <i class="fas fa-arrow-right"></i>',
            'hero.stat1.label': 'AUM (RMB)',
            'hero.stat1.unit': 'B',
            'hero.stat2.label': 'Risk Profile',
            ...
            'products.featured.desc': '≥90% allocation to high-grade credit, interest rate bonds & interbank CDs. The strategy focuses on liquidity management, credit selection, and prudent risk controls. Returns are not guaranteed and may fluctuate with market conditions.*',
            'products.fph1.title': 'AAA+ Credit Rating',
            'products.fph1.desc': 'State-owned banks & institutional platforms only',
            'products.fph2.title': 'Measured Return Objective',
            'products.fph2.desc': 'Disciplined risk management',
            ...
            'about.subtitle': 'We combine investment process, risk governance, and transparent reporting to support long-term client outcomes.',
            ...
            'ann.qgef.card2.val': 'Risk-managed',
            'ann.qgef.card2.label': 'Return Objective',
            ...
            'contact.social.title': 'Tap to Contact',

            // Footer
            'footer.tagline': 'Driving financial innovation with integrity and technology.',
            'footer.rights': 'All rights reserved.',
            'footer.disclaimer': '* Past performance does not guarantee future results. Investment involves risk. The information on this website is for reference only and does not constitute an offer or investment advice.',
            ...
            'reg.archive.contact': 'or call +852 6653 6748 ext. 201.',
            ...
            'fund.quickinfo.code': 'Product Code: MIN:FJMIN818815839K',
            'fund.quickinfo.manager': 'Manager: Fujian Jinnong Sui Fund Management Co., Ltd.',
            'fund.quickinfo.type': 'Fund Type: Open-Ended Contractual',
            'fund.legal.li1': 'Registration document approved by CSRC',
            'fund.legal.li2': 'Fund Contract of Fujian Jinnong Sui Stable Income Fund Management Co., Ltd.',
            'fund.legal.li3': 'Custody Agreement of Fujian Jinnong Sui Stable Income Fund Management Co., Ltd.',
            'fund.legal.li4': 'Legal opinion letter',
            'fund.legal.li5': 'Fund manager business qualification approval and business license',
            'fund.legal.li6': 'Fund custodian business qualification approval and business license',

            'fund.hl1.title': '"Fixed Income+" Stable Strategy',
            'fund.hl1.desc': '≥90% allocation to high-grade credit, interest rate bonds & interbank CDs, with emphasis on liquidity, credit selection, and drawdown control. Return objectives are not guaranteed.*',
            ...
            'fund.hl3.desc': 'Dynamic risk controls with independent oversight. Minimum subscription from $5,000.*',
            ...
            'fund.h1.desc': 'Adopts a "Fixed Income+" strategy with ≥90% allocation to high-grade credit, interest rate bonds and interbank CDs to support a stable income foundation.',
            ...
            'fund.target.value': 'Benchmark-aligned return objective with prudent risk controls*',
            ...
            'fund.risk.2': 'Dynamic stop-loss mechanism designed to protect portfolio value during market downturns.',
            ...
            'fund.facts.return': 'Historical Range',
            'fund.facts.return.val': 'Benchmark-aligned objective*',
        ...
        zh: {
            ...
            // Hero - index
            'hero.heading': '紀律化資本，<span class="highlight">透明</span>管理',
            'hero.subtitle': '金農穗基金管理有限公司提供紀律化基金管理方案，涵蓋固定收益、量化及風險管理策略。',
            'hero.cta': '查看產品',
            'hero.cta2': '查閱披露文件 <i class="fas fa-arrow-right"></i>',
            'hero.stat1.label': '管理規模 (RMB)',
            'hero.stat1.unit': '億',
            'hero.stat2.label': '風險等級',
            ...
            'products.featured.desc': '不低於90%資產配置於高等級信用、利率債及同業單，策略重點在流動性管理、信用篩選及審慎風險控制。收益不作保證，並可能隨市場狀況波動。*',
            'products.fph1.title': 'AAA+ 信用評級',
            'products.fph1.desc': '僅投國有銀行及機構平台',
            'products.fph2.title': '審慎回報目標',
            'products.fph2.desc': '紀律化風險管理',
            ...
            // About - index
            'about.title': '核心業務',
            'about.subtitle': '我們結合投資流程、風險治理與透明報告，支持客戶的長期目標。',
            ...
            'ann.qgef.card2.val': '風險管理',
            'ann.qgef.card2.label': '回報目標',
            'ann.qgef.card3.val': 'T+30',
            ...
            'contact.social.title': '點擊聯絡',

            // Footer
            'footer.tagline': '以誠信和科技推動金融創新。',
            'footer.rights': '版權所有。',
            'footer.disclaimer': '* 過往表現不代表未來結果。投資涉及風險。本網站資訊僅供參考，不構成要約或投資建議。',
            'footer.privacy': '隱私權',
            'footer.terms': '條款',
            ...
            'reg.archive.contact': '或致電 +852 6653 6748 轉 201。',
            'btn.viewOnline': '線上看',
            'published': '發布日期',
            ...
            'fund.quickinfo.code': '產品代碼：閩:FJMIN818815839K',
            'fund.quickinfo.manager': '管理法人：福建商金農穗基金管理有限公司',
            'fund.quickinfo.type': '基金運作方式：契約型開放式',
            'fund.legal.li1': '中國證監會准予註冊的文件',
            'fund.legal.li2': '《福建商金農穗穩盈基金管理有限公司基金合同》',
            'fund.legal.li3': '《福建商金農穗穩盈基金管理有限公司基金托管協議》',
            'fund.legal.li4': '法律意見書',
            'fund.legal.li5': '基金管理人業務資格批件、營業執照',
            'fund.legal.li6': '基金托管人業務資格批件、營業執照',

            'fund.hl1.title': '"固收+"穩健策略',
            'fund.hl1.desc': '不低於90%資產配置於高等級信用、利率債及同業單，重點關注流動性、信用篩選及回撤控制。回報目標不作保證。*',
            'fund.hl2.title': '福建區域精選',
            'fund.hl2.desc': '國有銀行及機構平台AAA+票據，T+6靈活申贖，持有≥30天免贖回費。',
            'fund.hl3.title': '嚴格風控',
            'fund.hl3.desc': '動態風險控制及獨立監督機制，最低認購$5,000元。*',
            ...
            'fund.h1.title': '"穩"字當頭',
            'fund.h1.desc': '採取"固收+"策略，不低於90%的資產配置於高等級信用、利率債及同業單，以支持穩健收益基礎。',
            ...
            'fund.target.value': '以基準為參考的回報目標，配合審慎風險控制*',
            'fund.risk.title': '風控機制',
            'fund.risk.1': '票券投資只選國有銀行、機構平台AAA+及以上信用評級，禁投私企民企票債',
            'fund.risk.2': '設有動態防護機制，旨在市場下行期間保護投資組合價值',
            ...
            'fund.facts.return': '過往表現區間',
            'fund.facts.return.val': '以基準為參考的目標*',
